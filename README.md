...
"React app which reads a list of profile from an api, creates a list. Has features where a person can hover the profile to view more details about that person. Can also search for a person from the search field" 
